...
let Experiment, engagementInit, sessionReplayPlugin;
if (typeof window !== 'undefined') {
  ...
  sessionReplayPlugin = require('@amplitude/plugin-session-replay-browser').sessionReplayPlugin;
}
...
// Create and Install Session Replay Plugin (only on client side)
if (typeof window !== 'undefined' && sessionReplayPlugin) {
...
export const logEvent = (event, eventProps = {}) => {
  // Session Replay properties are automatically added by the plugin
  analytics.track(
    event,
    eventProps,
    {
